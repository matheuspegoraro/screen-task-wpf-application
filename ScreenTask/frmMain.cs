...
namespace ScreenTask
{
    public partial class frmMain : Form
    {
        ...
        private void TakeScreenshot(bool captureMouse)
        {
            if (captureMouse)
            {
                var bmp = ScreenCapturePInvoke.CaptureFullScreen(true, comboMonitors.SelectedIndex);
            ...
            {
                var bmp = ScreenCapturePInvoke.CaptureFullScreen(false, comboMonitors.SelectedIndex);
                rwl.AcquireWriterLock(Timeout.Infinite);
                bmp.Save(Application.StartupPath + "/WebServer" + "/ScreenTask.jpg", ImageFormat.Jpeg);
                rwl.ReleaseWriterLock();
